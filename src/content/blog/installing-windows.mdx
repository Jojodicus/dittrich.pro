...
date: 2024-01-10
thumbnail: '../../images/blog/installing-windows/windows-bloom.jpg'
---

import Admonition from '../../components/Admonition.astro';
import { Image } from 'astro:assets';
import setupLanguage from '../../images/blog/installing-windows/setup-language.png';
import setupKey from '../../images/blog/installing-windows/setup-key.png';
import setupVersion from '../../images/blog/installing-windows/setup-version.png';
import setupDisksWritten from '../../images/blog/installing-windows/setup-disks-written.png';
import setupDisksFree from '../../images/blog/installing-windows/setup-disks-free.png';
import postSetupTelemetry from '../../images/blog/installing-windows/post-setup-telemetry.png';
import postSetupMsAccount from '../../images/blog/installing-windows/post-setup-ms-account.png';
import postSetupOops from '../../images/blog/installing-windows/post-setup-oops.png';
import finishedInstall from '../../images/blog/installing-windows/finished-install.png';
...
<Image src={setupLanguage} alt="Choose language preferences" />
...
<Image src={setupKey} alt="Providing a product key" />
...
<Image src={setupVersion} alt="Choose version" />
...
<Image src={setupDisksWritten} alt="Drive setup with previous installation" />

Delete every partition, now we have:

<Image src={setupDisksFree} alt="Drive selection" />
...
<Image src={postSetupTelemetry} alt="Telemetry options" />
...
<Admonition type="tip" title="Tip">
  ...
  this requirement, press <kbd>Shift</kbd> + <kbd>F10</kbd>. This will bring up
  a command line. Type in `OOBE\BYPASSNRO` (without backticks) and hit{' '}
  <kbd>Enter</kbd>. The system will now reboot and can then be installed without
  internet. After the installation, you can then manually get the drivers from
  your mainboard's website via another system with internet access. Download
  them onto a USB drive (the one used as an installation medium will suffice)
  and install them on your new system, you should be able to connect to the
  internet then.
</Admonition>
...
<Image src={postSetupMsAccount} alt="Requires Microsoft account" />

<Image src={postSetupOops} alt="Bypass account requirement" />
...
<Admonition type="info" title="Info">
  ...
  valid credentials. To bypass this, press <kbd>Shift</kbd> + <kbd>F10</kbd>,
  ...
  bring up the terminal again with <kbd>Shift</kbd> + <kbd>F10</kbd> and type in
  `ipconfig /release`, then press <kbd>Enter</kbd>. This will disable the
  internet for the setup, making a purely offline installation possible, even
  with a LAN-cable plugged in. The setup will ask for a internet connection
  anyways, simply skip it and let it continue without internet access.
</Admonition>

# Post Installation

<Image src={finishedInstall} alt="finished" />
