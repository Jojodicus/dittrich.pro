...
date: 2024-12-17
thumbnail: '../../images/blog/cloudflare-tunnel-homelab/orange-clouds.jpg'
---

import Admonition from '../../components/Admonition.astro';
import { Image } from 'astro:assets';
import zeroTrust from '../../images/blog/cloudflare-tunnel-homelab/zero-trust.png';
import tunnelDash from '../../images/blog/cloudflare-tunnel-homelab/tunnel-dash.png';
import tunnelToken from '../../images/blog/cloudflare-tunnel-homelab/tunnel-token.png';
import tunnelEntry from '../../images/blog/cloudflare-tunnel-homelab/tunnel-entry.png';
import dnsToken from '../../images/blog/cloudflare-tunnel-homelab/dns-token.png';
import adguardRewrite from '../../images/blog/cloudflare-tunnel-homelab/adguard-rewrite.png';
...
<Image src={zeroTrust} alt="Zero Trust" />
...
<Image src={tunnelDash} alt="Tunnel Creation" />
...
<Image src={tunnelToken} alt="Token" />
...
<Image src={tunnelEntry} alt="Tunnel Entry" />

This will create a tunnel for [https://one.sysleave.de](https://one.sysleave.de) to the `service1` container, which serves its content via HTTP.
...
We are now able to access our services from outside via the encrypted tunnel, using [https://one.sysleave.de](https://one.sysleave.de) and [https://two.sysleave.de](https://two.sysleave.de).
...
To get your DNS API token, head to [https://dash.cloudflare.com/profile/api-tokens](https://dash.cloudflare.com/profile/api-tokens) and create a token for "Edit zone DNS".
You will only need to change the rightmost field in "Zone Resources" to your domain:

<Image src={dnsToken} alt="DNS Token" />
...
<Image src={adguardRewrite} alt="AdGuard Rewrite" />
